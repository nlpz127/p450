...
void mainloop1()
{
    ...
    while(ros::ok())
    {
        ...
        switch (Control_Mode)
        {
			...
			//cout << Command_to_pub.header.stamp << endl;
			//cout << prometheus_msgs::ControlCommand::Takeoff << endl;
			//cout << Command_to_pub.Mode << endl;		
			//cout << Command_to_pub.Command_ID + 1 << endl;
			//cout << Command_to_pub.Command_ID << endl;
			//cout << NODE_NAME << endl;
			//cout << Command_to_pub.source << endl;
                move_pub.publish(Command_to_pub);
                break;
